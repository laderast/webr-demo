...
```{js}
webR.evalRVoid("download.file('https://laderast.github.io/webr-demo/data/penguins.csv', 'penguins.csv')");
```
...
- Education
- Internal Websites 
- Give other people a chance with data
...
- There is a filesystem that is created
  - emscripten webassembly filesystem
...
```{webr-r}
download.file('https://laderast.github.io/webr-demo/data/penguins.csv', 'penguins.csv')
list.files()
```
